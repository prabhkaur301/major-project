...
###############################  &malicious url input processing  begins ###########################
...
def URL_Converter(urls):
    ...
    data['url'] = data['url'].replace('www.|https://', '', regex=True)
    print("removed https and http",data['url'])
...
###############################  &malicious url input processing  end ###########################
